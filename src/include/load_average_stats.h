...
Classes and functions used with run queue and load average data 
stat collection code.
*/
// ----------------------------------------------------------- //   
#ifndef __LOAD_AVERAGE_STATS_HPP__
#define __LOAD_AVERAGE_STATS_HPP__
...
#endif // __LOAD_AVERAGE_STATS_HPP__
// ----------------------------------------------------------- // 
// ------------------------------- //
// --------- End of File --------- //
// ------------------------------- //
